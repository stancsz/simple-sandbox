...
- [ ] **Adaptive Model Routing**: Dynamically route LLM requests (e.g., using Haiku/Flash for parsing and Opus/Reasoner for complex reasoning) based on task complexity scores generated by the `business_ops` MCP.
