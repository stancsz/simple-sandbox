...
5. **Auditing & Ecosystem Visibility**: Every successful spawn operation, merge, or retirement is permanently logged. The **Ecosystem Auditor MCP** monitors these morphology adjustments, cross-agency communications, and policy changes. The **Health Monitor Dashboard** provides a real-time topology graph and decision trail timeline to visualize the entire ecosystem's structural changes.
